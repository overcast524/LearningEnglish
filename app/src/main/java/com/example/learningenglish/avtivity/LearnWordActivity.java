...
import com.example.learningenglish.adapter.MeanChoiceAdapter;
import com.example.learningenglish.database.Interpretation;
import com.example.learningenglish.database.LearnTime;
...
import com.example.learningenglish.listener.OnItemClickListener;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(LearnWordActivity.this,MainActivity.class));
                finish();
            }
        });
    }
