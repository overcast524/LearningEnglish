...
import com.example.learningenglish.adapter.WordFolderListAdapter;
...
import com.example.learningenglish.entity.ItemWordList;
...
public class FolderDetailActivity extends BaseActivity {
    ...
    private ImageView imgStart,imgBack;
    ...
    private void init() {
        ...
        imgBack = findViewById(R.id.img_fd_back);
    }
